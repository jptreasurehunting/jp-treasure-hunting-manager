    ...
    <div className="search-results-container card">
      <div className="card-header space-between">
        <div className="results-header-title">
          ...
          <h3 className="card-title font-bold text-sm">該当出品一覧 ({listings.length}件ヒット)</h3>
        </div>
        <span className="results-subtitle-badge">
          「{query}」の検索結果 — 出品を選択して Seller Hub で Sell Similar を起動
        </span>
      </div>

      <div className="card-body">
        <p className="results-instruction font-medium text-xs text-muted mb-3">
